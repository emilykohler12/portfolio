...
export default function Services() {
  return (
    <section id="servicios" className="mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-24">
      ...
      <div className="mt-12 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
        {services.map((service, index) => (
          <div
            key={service.title}
            className="rounded-2xl border border-forest/15 bg-cream-soft p-6"
          >
            <span className="flex h-9 w-9 items-center justify-center rounded-full bg-pink-soft font-serif text-xs font-bold text-forest">
